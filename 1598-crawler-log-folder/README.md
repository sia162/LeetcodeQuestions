...
<p>You are given a list of strings <code>logs</code> where <code>logs[i]</code> is the operation performed by the user at the <code>i<sup style="">th</sup></code> step.</p>
...
<ul>
	<li><code>1 &lt;= logs.length &lt;= 10<sup style="">3</sup></code></li>
